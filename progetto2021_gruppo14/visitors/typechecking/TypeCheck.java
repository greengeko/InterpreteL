...
import static progetto2021_gruppo14.visitors.typechecking.PrimType.*;
...
public class TypeCheck implements Visitor<Type> {
	...
	@Override
	public PrimType visitNotEq(Exp left, Exp right) {
	...
	public ProdType visitBounds(Exp exp) {
		var start = INT.checkEqual(exp.accept(this).getStartRangeType());
		var end = INT.checkEqual(exp.accept(this).getEndRangeType());
